...
|4| (1/23)<br>[Procedural Python, part 2](https://uwdirect.github.io/SEDS_content/05.Procedural_Python.part2.pptx), [Notebook](https://uwdirect.github.io/SEDS_content/05.Procedural_Python.part2.ipynb), [(video)]()<br>P-values and hypothesis testing | (1/25)<br>Debugging & unit tests<br>Overview of machine learning methods and Classification problems | [Nuzzo2014](http://www.nature.com/news/scientific-method-statistical-errors-1.14700) , [ASA P-values](asa statement on statistical significance and p-values) 
