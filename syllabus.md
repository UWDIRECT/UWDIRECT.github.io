...
|2| (1/9)<br>[Introduction to Python & Jupyter notebooks](https://uwdirect.github.io/SEDS_content/02.Python.pptx), ([Python intro notebook](https://uwdirect.github.io/SEDS_content/02.Python.ipynb), [Jupyter intro notebook](https://uwdirect.github.io/SEDS_content/02.Jupyter.ipynb))<br>Visualization basics | (1/11)<br>Introduction to version control, part 1<br>Review of statistical methods, part 1 | [Learn Git in 15 minutes](https://try.github.io/levels/1/challenges/1) | |
